...
const smtpConfigFile = "smtp_config.json"; // Novo arquivo para configurações SMTP
...
// Carrega a configuração SMTP do arquivo ou usa o padrão
...
app.get("/config", (req, res) => {
    ...
    const response = {
        ...
        configSmtp: smtpConfig     // Adiciona a configuração SMTP à resposta
    };
    res.json(response);
});
